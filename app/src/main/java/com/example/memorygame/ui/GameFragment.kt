...
class GameFragment : Fragment() {
    ...
    private fun startRound() {
        ...
        while (highlightedIndices.size < tilesToRemember) {
            highlightedIndices.add(Random.nextInt(GRID_SIZE))
        }
    ...
    private fun startSelectionTimer() {
        Toast.makeText(requireContext(), getString(R.string.your_turn_message), Toast.LENGTH_SHORT).show()
    ...
    private fun endGame(message: String) {
        ...
        Toast.makeText(
            requireContext(),
            "$message ${getString(R.string.final_score_format, score)}",
            Toast.LENGTH_SHORT
        ).show()
